...
class CartContainers extends Component {
  ...
  showCartItem = (cart, onDeleteProductInCart, onChangeMessage, onUpdateProductInCart) => {
    var result =
      <tr>
  ...
  render() {
    ...
    return (
      <Cart>
        {this.showCartItem(cart, onDeleteProductInCart, onChangeMessage, onUpdateProductInCart)}
